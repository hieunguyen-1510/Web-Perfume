...
$connection = mysqli_connect('localhost', 'root', '', 'web_perfume');
...
// Truy vấn để lấy sản phẩm nổi bật từ cơ sở dữ liệu
$query = "SELECT * FROM products WHERE category = 'outstanding'";
            ...
            <div class="outstanding-products">
                ...
                <div class="container">
                    <div class="products-item">
                        ...
                        <a href="" class="buy-sp">Mua ngay</a>
